...
You can download the PDF and Epub version of this repository from the latest run on the [actions tab](https://github.com/ritik177/JavaScript_Interview_Questions/actions).
